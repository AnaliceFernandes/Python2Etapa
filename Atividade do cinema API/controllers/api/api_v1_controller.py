...
def api_buscar_tmdb():
    termo = request.args.get("q", "") #TODO responda por que estamos utilizando o request.args.get?: O request.args.get("q, "") busca o parâmetro "q" da URL, retornando vazio "" se ele mão existir.
